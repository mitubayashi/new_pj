        ...
        <div class="body_area">
            <form action="listJump.php" method="post" enctype="multipart/form-data">
                <?php
                    ...
                    echo "<br><br><br>";
                    echo "<FONT color='red'>ユーザ単位の経費情報が取り込みできます。取り込み情報は</FONT><br><br>";
                    echo "<FONT color='red'>プロジェクトコード(12桁ハイフンあり)、社員番号、旅費交通費、その他、日付(yyyy/mm/dd)<br>をCSV形式で作成してください。</FONT><br><br>";
                    echo "<FONT color='red'>同一プロジェクトにすでに登録データが存在する場合は追加で登録されます。</FONT><br><br>";
                ?>
            </form>
        </div>
